...
boton1 = tk.Button(root, text="CLIENTE", command=lambda: ejecutar_archivo("clienttransfer.py"))
boton1.pack(pady=5)

boton2 = tk.Button(root, text="SERVIDOR", command=lambda: ejecutar_archivo("servertransfer.py"))
boton2.pack(pady=5)
root.mainloop()
